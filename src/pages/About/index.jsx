    ...
    <article className="container about-page">
      <div className="text-zone">
        ...
        <p>
          ...
          building dynamic web applications with a responsive design across all
          devices. skilled in HTML5, CSS3, JavaScript, Sass, Bootstrap, and
          React. and have basic knowledge of python, C++, git, SQL, Figma, and
          UI/UX design.{' '}
        </p>
        <p>
          Prior to that, I worked as a lawyer which allowed me to gain a
          problem-solving mindset. Interested in mastering programming and eager
          to learn more in that changeable field.{' '}
        </p>
        <p>
